# Generated by Powerlevel10k configuration wizard on 2020-01-16 at 13:44 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 33624.
# Wizard options: powerline, lean, time, 2 lines, solid, no frame, darkest, sparse,
# concise.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=76 #180
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@Azure'
